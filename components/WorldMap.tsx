  ...
  return (
    ...
    >
      ...
      <div className="absolute top-36 md:top-20 left-4 z-20 font-sans">
        <div className="relative">
            <button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-full shadow-2xl border backdrop-blur-xl transition-all active:scale-95 ${
                    isFilterOpen || selectedTypes.size > 0
      ...
      <div className="absolute bottom-8 right-6 z-10 flex flex-col space-y-3 items-center">
          ...
          <div className="relative">
             {locationMsg && (
                <div className={`absolute right-14 top-1/2 -translate-y-1/2 whitespace-nowrap px-3 py-1.5 rounded-lg text-[10px] font-medium shadow-2xl border backdrop-blur-xl animate-in fade-in slide-in-from-right-2 z-50 ${
